    ...
    <div className="space-y-8 max-w-7xl mx-auto h-full flex flex-col">
      <header className="flex items-center justify-between shrink-0">
        <div>
          ...
          <p className="text-ps-text-muted">Manage pawned items and retail stock.</p>
        </div>
      ...
      <SquishyCard className="flex-1 flex flex-col min-h-0">
        <div className="flex items-center gap-4 mb-6">
          <div className="relative flex-1">
            ...
            <input 
              type="text" 
              placeholder="Search by SKU, description, or customer..." 
        ...
        <div className="flex-1 border border-white/5 rounded-xl overflow-hidden flex flex-col">
          ...
          <div className="flex-1 flex items-center justify-center p-8">
            <div className="text-center">
              ...
              <p className="text-sm text-ps-text-muted mb-4">Your inventory is currently empty.</p>
              <SquishyButton variant="outline" size="sm">Add your first item</SquishyButton>
            </div>
          </div>
        </div>
      </SquishyCard>
