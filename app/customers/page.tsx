        ...
        <div className="flex-1 border border-white/5 rounded-xl overflow-hidden flex flex-col">
          ...
          <div className="flex-1 flex items-center justify-center p-8">
            <div className="text-center">
              ...
              <p className="text-sm text-ps-text-muted mb-4">Your customer database is currently empty.</p>
              <SquishyButton variant="outline" size="sm">Add your first customer</SquishyButton>
            </div>
          </div>
        </div>
      </SquishyCard>
